...
export default function Footer() {
  return (
    <footer className="bg-black/85 text-white pt-16 pb-8">
      <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        {/* Brand & Social */}
        <div>
          <h3 className="text-xl font-bold mb-4">Clutch Auto Sales</h3>
          <p className="mb-5 text-gray-400 leading-relaxed">
            Your trusted source for quality pre-owned vehicles in Anderson, IN.
          </p>
        ...
        <div>
          ...
          <address className="not-italic text-gray-400 space-y-2">
            ...
            <p>
              <a
                href="mailto:Thrivingautomotives@gmail.com"
                className="hover:text-red-500 transition"
              >
                Thrivingautomotives@gmail.com
              </a>
            </p>
          </address>
        </div>
      ...
      <div className="border-t border-gray-800 mt-12 pt-6 text-center text-sm text-gray-500">
        <p>
          &copy; {new Date().getFullYear()} Clutch Auto Sales. All rights
          reserved.
        </p>
